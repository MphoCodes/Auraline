...
function BatteryIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 28 24">
      ...
      <path d="M24.5 10v4" />
      <path className="battery-level" d="M6 10h11v4H6z" />
    </svg>
  )
}
  ...
  return (
    <header className="menu-bar">
      ...
      <div aria-label="System status" className="system-status">
        ...
        <span aria-label="Wi-Fi connected" className="status-icon" role="img">
          <WifiIcon />
        </span>
        <span aria-label="Battery at 82 percent" className="status-icon battery-status" role="img">
          <BatteryIcon />
          <span>82%</span>
        </span>
